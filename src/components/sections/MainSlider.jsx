...
const mainSliderArr = [
	{ title: "Самые вкусные роллы только у нас!", imageUrl: "01.webp", link: "category/sushi" },
	{ title: "Самая вкусная пицца только у нас!", imageUrl: "02.webp", link: "category/pizza" }
];
			...
			<div className="_container">
				{!isLoading ?
					...
					<div className="main-slider__loading" title="loading...">
						<div class="main-slider__loading-icon">
