...
function BasketCard({
	...
	const removeCardFromBasket = () => dispatch(setRemoveProductFromBasket(parentId));

	const minusProductCount = () => dispatch(setMinusProductToBasket(parentId));

	const plusProductCount = () => dispatch(setPlusProductToBasket(parentId));
		...
		<article className="basket-card">
			...
			<div className="basket-card__column">
				<div className="basket-card__actions basket-card-actions">
					...
					<span className="basket-card-actions__count">
						{count}
					</span>
					<button
						className={classNames(
				...
				<div className="basket-card__price">
					<span className={classNames(
						"basket-card__price-text",
						price.stock && "basket-card__price-text_stock"
					)}>{price.value}₴</span>
				...
				<button onClick={removeCardFromBasket} className="basket-card__remove" type="button">
					...
					<span className="basket-card__remove-text">
						Удалить
					</span>
				</button>
			</div>
