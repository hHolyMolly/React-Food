...
function ProductCard({ id, images, title, contain, category, price, stock }) {
  ...
  return (
    <article className="product-card">
      ...
      <button className={classNames("product-card__favorite", findItemFavorite && "_active")} onClick={addedToFavorite} type="button" aria-label={findItemFavorite ? "Убрать из избранного" : "Добавить в избранное"}>
