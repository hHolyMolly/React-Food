...
function ProductCard({
	...
	return (
		<article className="product-card">
			...
			)} onClick={addedToFavorite} type="button">
				...
				<div className="product-card__footer product-card-footer">
					<div className="product-card-footer__row">
						...
						<strong className={classNames(
							...
							price.stock && "product-card-footer__price_stock"
						)}>{price.value}₴</strong>
						{price.stock &&
							<strong
								className="product-card-footer__price product-card-footer__price_absolute"
							>{price.stock}₴</strong>}
					</div>
					<ButtonBasket />
				</div>
